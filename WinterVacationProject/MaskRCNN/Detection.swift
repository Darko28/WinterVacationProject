...
public struct Detection {
    ...
    public static func detectionsFromFeatureValue(featureValue: MLFeatureValue, maskFeatureValue: MLFeatureValue?) -> [Detection] {
    ...
    static func maskFromFeatureValue(maskFeatureValue: MLFeatureValue, atIndex index: Int) -> CGImage? {
        ...
        let image = CGImage(maskWidth: 28, height: 28, bitsPerComponent: 8, bitsPerPixel: 8, bytesPerRow: 28, provider: CGDataProvider(data: data)!, decode: nil, shouldInterpolate: false)
